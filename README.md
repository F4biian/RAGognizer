...
- **arXiv:** [https://arxiv.org/abs/2604.15945v1](https://arxiv.org/abs/2604.15945v1)
...
> [!WARNING]
> **This library is experimental and will not be maintained in the future!**  
> It enforces the usage of old and unmaintained libraries.

```sh
pip install "git+https://github.com/F4biian/RAGognizer.git#subdirectory=ragognizer"
```
